        ...
        <>
            ...
            <div className="max-w-3xl mx-auto bg-white shadow-xl p-10 rounded-3xl mt-10 mb-10">
                <div className="md:flex sm:mb-10 justify-between items-center mb-8">
                    <h2 className="mt-5 text-2xl font-bold text-[#c19b5a] border-l-4 border-[#c19b5a] pl-4">Your Profile</h2>
                    <div className="flex mt-5">
                        <button
                            onClick={() => logout()}
                            className="flex px-5 py-2 bg-[#c19b5a] text-white rounded-full hover:bg-[#b28e4f] mr-3 gap-2"
                        >
                    ...
                    {editing && (
                        <div className="flex gap-4 md:col-span-2 justify-center mt-4 ml-[50%]">
                            ...
                            <button
                                ...
                                className="px-8 py-3 border border-[#c19b5a] text-[#c19b5a] rounded-full "
                            >
