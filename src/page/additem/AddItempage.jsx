          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                focus:outline-none focus:ring-2 focus:ring-[#c19b5a]"
            ...
            <div>
              ...
              <div className="flex gap-3">
                <input
                  ...
                  className="mt-2 w-[80%] bg-gray-50 border border-gray-300 p-3 rounded-full
                  focus:outline-none focus:ring-2 focus:ring-[#c19b5a]"
                />
                ...
                {selectedFile && (
                  <button
                    ...
                    className="mt-2 px-5 py-2 border border-[#c19b5a] text-[#c19b5a] rounded-lg w-[20%]"
                  >
                    Add
                  </button>
                )}
            ...
            <button
              ...
              text-lg font-semibold hover:bg-[#b2843f] transition"
            >
              Submit
            </button>
          </form>
