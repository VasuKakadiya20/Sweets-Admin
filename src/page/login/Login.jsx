...
export default function LoginPage() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await postData("/user/loginuser", formData);
    ...
    return (
        <>
            ...
            <div className="min-h-screen flex items-center justify-center p-4 bg-[#F4F1EA]">
                <div className="bg-white w-full max-w-4xl rounded-3xl grid grid-cols-1 md:grid-cols-2 overflow-hidden shadow-2xl">
                    <div className="p-10 flex flex-col justify-center">
                        {/* <h3 className="flex items-center text-gray-700 mb-2 gap-2 text-sm font-medium">
              Admin Side 
            </h3> */}
                        <h2 className="text-3xl font-bold mb-1 text-[#E09F40]">WELCOME BACK</h2>
                        <p className="mb-8 text-gray-500">Access your admin Side</p>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    placeholder="Email"
                                    className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#E09F40]"
                                />
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full p-3 border border-gray-300 rounded-md  mt-2 focus:outline-none focus:ring-2 focus:ring-[#E09F40]"
                                />
                            </div>

                            <button type="submit" className="w-full text-white py-3 rounded-md font-medium hover:bg-[#caaa71] transition-all btn-viewall2">
                                Sign in
                            </button>
                        </form>
                        <button className="w-full border-1 border-[#E09F40] py-3 rounded-md mt-4 flex items-center justify-center gap-3 hover:bg-gray-100 transition-all">
                            <img
                                src="https://www.svgrepo.com/show/475656/google-color.svg"
                                alt="Google"
                                className="w-5 h-5"
                    ...
                    <div className="hidden md:flex items-center justify-center bg-white p-10">
                        <img src={laptop} alt="Illustration" className="w-80" />
                    </div>
                </div>
            </div>
        </>
